...
\subsection{Filtering real data}

The performance of the filter can be shown on subsequence of data used in chapter \ref{cap:attitude_subsystem_identification}. The figure \ref{fig:kalman1} shows velocity in one of attitude axis of UAV measured by \emph{px4flow} sensor. 

\begin{figure}[h]
\includegraphics[width=1\textwidth]{fig/kalman1.eps} 
\caption{Kalman filter tracking a noisy singal of UAV's speed in one attitude axis.}
\label{fig:kalman1}
\end{figure}