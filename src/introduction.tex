...
Almost all of presented works implement a single MPC approach to control the vehicle as well as to create the optimal trajectory. We aim to decompose those systems. The thesis presents MPC controller, our other related work describes the trajectory planning \citep{saska_baca2014, saska2014formations}.
...
\begin{itemize}
\item We designed a hardware platform specifically intended for UAV experiments.
