...
measurement_covariance = diag([0.0058, 0.03, 0, 0, 0]);
...
hold off
plot(time(1:end-1), x(5, 1:(i-1)), 'r', 'LineWidth', 1.5);
hold on
plot(time(1:end-1), estimate(5, 1:(i-1)), 'b', 'LineWidth', 1.5);
title('Disturbance');
legend('Disturbance', 'Estimation');
xlabel('Time [s]');
ylabel('Acceleration [m/s^2]');
axis([0 dt*i -0.05 0.25]);
